...
public interface IAppointmentService
{
    ...
    Task<Result<IEnumerable<AppointmentListItemDto>>> GetByUserAsync(Guid userId, CancellationToken cancellationToken = default);
    Task<Result<IEnumerable<AppointmentDto>>> GetByPatientAsync(Guid patientProfileId, CancellationToken cancellationToken = default);
