...
public class AppointmentSearchRequestSelectionCommand(AppointmentSearchRequestDto appointment, IServiceProvider serviceProvider) : IMenuCommand
{
    ...
    public async Task<MenuResult> ExecuteAsync(CancellationToken cancellationToken = default)
    {
        ...
        var appointmentSearchRequestsSelectionProvider = serviceProvider.GetRequiredService<AppointmentSearchRequestsSelectionProvider>();
