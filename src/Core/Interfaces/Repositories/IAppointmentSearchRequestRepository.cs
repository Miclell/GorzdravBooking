...
public interface IAppointmentSearchRequestRepository
{
    ...
    Task<IEnumerable<AppointmentSearchRequest>> GetByPatientProfileIdAsync(Guid patientProfileId,
        CancellationToken cancellationToken = default);

    Task<IEnumerable<AppointmentSearchRequest>> GetActiveByUserIdAsync(Guid userId,
        CancellationToken cancellationToken = default);
